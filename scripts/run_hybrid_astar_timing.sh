...
TOPIC="${TOPIC:-ground_hybrid_astar_timing_30_old_union}"
...
COMMAND=(
  python "$ROOT/scripts/run_hybrid_astar_timing.py"
  --scene old_union
  --config "$CONFIG"
...
cp scripts/run_hybrid_astar_timing.py \
  scripts/run_hybrid_astar_timing.sh \
