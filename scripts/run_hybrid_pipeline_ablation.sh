...
TOPIC="${TOPIC:-ground_hybrid_pipeline_bcd_ablation_old_union}"
...
COMMAND=(
  ...
  --plain-bezier-anchor-spacing-meters 0.50
  --plain-bezier-samples-per-section 50
...
- C: obstacle-unaware chord-length C1 piecewise cubic Bezier, with anchors every 0.50 m.
- D: dense Hybrid A* seed -> GS safety corridor -> degree-6 Bezier QP -> 5 1/m curvature feasibility check.
